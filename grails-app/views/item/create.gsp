...
<h1 class="izquierda">INGRESE ITEM</h1>


<fieldset>
<g:form action = "save" >
    <p>
        <label class="fuenteCursiva" id="texto"  style="display:none">SKU/Description</label>
        <!--g:field type="text" placeholder="Nombre y Apellido"  name="nombre"/--><br>
        <g:field   id="nomyAp" class="input_sub_largo" type="text" placeholder="SKU/Description"  name="SKU" onclick="elementoVisible('texto')" required ="true" />
        <br><br>
        <!--input2 type="text" class="InputSinBordes" value= "Nombre y apellido"-->
    </p>
    <label class="fuenteCursiva" id="texto2" style="display:none">CodigoDeBarras</label><br>
    <g:field  class ="input_sub_largo" type="text" placeholder="CodigoDeBarras"  name="CodigoDeBarras" onclick="elementoVisible('texto2')" required = "true" />

    <br><br>

    <p>
        <label class="fuenteCursiva" id="texto3" style="display:none">Precio</label><br>
        <g:field  class ="input_sub_corto" type="text" placeholder="Precio" name="Precio" onclick="elementoVisible('texto3')"/>
    ...
    <g:submitButton name="submit" class="boton" value="Guardar Item"/>
